                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('profile.update'), $user->id }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="username" type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" value="{{ old('username', $user->username) }}" required>
                            @error('username')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
